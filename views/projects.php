...
<div class="marge" style="margin-right: 90%; margin-top: 1%; margin-left: 1%;">
  ...
  <div class="row" style="margin-top: 1%; margin-left: 3%;">
    <div class="col-2"></div>
    <div class="col-8" style="background-color: white; border-radius: 10px; padding: 1%;">
      ...
      <table class="table">
        <thead class="table-secondary">
          <tr>
            ...
            <th class="col-2"></th>
            <th class="col-2">Estimated period</th>
            <th class="col-2"></th>
          </tr>
        </thead>
    ...
    <div class="col-8" style="background-color: white; border-radius: 10px; padding: 1%;">
      ...
      <table class="table">
        <thead class="table-secondary">
          <tr>
            <th class="col-3">Name</th>
            <th class="col-1">Total spent</th>
            <th class="col-1">M-10 spent</th>
            <th class="col-1">M-6 spent</th>
            <th class="col-1">M-1 spent</th>
            <th class="col-2"></th>
            <th class="col-1">Dates</th>
            <th class="col-1">Nb days</th>
            <th class="col-2"></th>
          </tr>
        </thead>
        <tbody class="table-group-divider table-divider-color">
